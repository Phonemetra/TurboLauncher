...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.phonemetra.turbo.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.phonemetra.turbo.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
